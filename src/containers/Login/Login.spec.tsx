...
const mockUseFormik = jest.fn(
    ({ onSubmit }: { onSubmit: (values: { email: string; password: string }) => Promise<void> }) => {
...
jest.mock("formik", () => ({
    useFormik: (args: unknown) => mockUseFormik(args as { onSubmit: (values: { email: string; password: string }) => Promise<void> }),
}));
